...
| `SpeedBlitzWindUpFeel` | Speed Blitz slice **2d** — wind-up electric VFX + wind-up/dash SFX + launch discharge burst; auto-added by `SpeedsterSpeedBlitzUlt`; driven by synced phase / connect freeze |
| `SpeedBlitzBodyGlow` | Speed Blitz dasher glow — ult blue tint + optional point light on avatar meshes; wind-up ramp, dash/connect peak, discharge at ragdoll launch; auto-added by `SpeedsterSpeedBlitzUlt` |
