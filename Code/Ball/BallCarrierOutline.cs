...
public sealed class BallCarrierOutline : Component
{
	...
	[Property] public float OutlineWidth { get; set; } = 1f;
	[Property] public float PulseSeconds { get; set; } = 1.2f;
	[Property] public float WidthReferenceDistance { get; set; } = 280f;
	[Property] public float MinWidthScale { get; set; } = 0.25f;
	[Property] public float MaxWidthScale { get; set; } = 0.6f;
	[Property] public bool EnableEmissivePulse { get; set; } = true;
	[Property] public float EmissiveBrightnessMin { get; set; } = 0f;
