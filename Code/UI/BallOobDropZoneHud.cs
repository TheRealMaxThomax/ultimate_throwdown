...
public sealed class BallOobDropZoneHud : Component
{
	...
	[Property, Group( "World stack" )] public Vector2 StackPanelSize { get; set; } = new( 2000f, 2000f );
	[Property, Group( "World stack" )] public float StackHeightAboveGround { get; set; } = 100f;
	...
	[Property, Group( "World stack" )] public float StackPanelPadding { get; set; } = 64f;
	[Property, Group( "World stack" )] public float StackRowGap { get; set; } = 48f;
	...
	[Property, Group( "World stack" )] public int CountdownFontSize { get; set; } = 146;
	[Property, Group( "World stack" )] public int CountdownFontWeight { get; set; } = 800;
	[Property, Group( "World stack" )] public int ArrowFontSize { get; set; } = 122;
	[Property, Group( "World stack" )] public int ArrowFontWeight { get; set; } = 800;
	[Property, Group( "World stack" )] public int DropZoneFontSize { get; set; } = 98;
	...
	[Property, Group( "Ground ring" )] public string RingModelPath { get; set; } = "models/Main/oob_drop_ring.vmdl";
	[Property, Group( "Ground ring" )] public string RingMaterialPath { get; set; } = "materials/oob_drop_ring.vmat";
	/// <summary> Model diameter in units at scale 1 — code scales to <see cref="RingDiameter"/>. </summary>
	[Property, Group( "Ground ring" )] public float RingModelBaseSize { get; set; } = 7.5f;
	...
	[Property, Group( "Ground ring" )] public float RingOutlineExtraDiameter { get; set; } = 16f;
