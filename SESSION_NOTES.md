...
- [ ] **Tackle impact feel — MP verify** — `TackleImpactFeel` hitstop + shake + attacker punch; 2-window host→client and client→host; tune on player prefab (`HitstopDurationSeconds`, shake amps, `ShakeForAttacker` / `ShakeForVictim`)
